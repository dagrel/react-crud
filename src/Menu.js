const Menu = [
    ...
    },
    {
        ...
        submenu: [{
            ...
            },
            {
                name: 'Saker',
                path: '/saker',
                translate: 'sidebar.nav.styrearbeid.CASES'
            },
            {
                name: 'Møter',
                path: '/moter',
                translate: 'sidebar.nav.styrearbeid.MEETINGS'
            },
            {
                name: 'Meldingssenter',
                path: '/meldingssenter',
                translate: 'sidebar.nav.styrearbeid.MESSAGES'
            }
        ]
    },
    {
        ...
        submenu: [{
                name: 'Medlemmer',
                path: '/medlemmer',
                translate: 'sidebar.nav.persons.MEMBERS'
            },
            {
                name: 'Foresatte',
                path: '/foresatte',
                translate: 'sidebar.nav.persons.PARENTS'
            },
            {
                name: 'Alle personer',
                path: '/personer',
    ...
    },
    {
        name: 'Kalender',
        icon: 'icon-calendar',
        translate: 'sidebar.nav.calendar.CALENDAR',
        submenu: [{
                name: 'Terminliste admin',
                path: '/terminliste-admin',
                translate: 'sidebar.nav.calendar.SCHEDULEADMIN'
            },{
                name: 'Terminliste',
                path: '/terminliste',
                translate: 'sidebar.nav.calendar.SCHEDULE'
            },
            {
                name: 'Kalender',
                path: '/kalender',
