        ...
        return (
            <ContentWrapper>
                <div className="content-heading">
                    <div>
                        <Trans i18nKey='components.members.BOARD_CALENDAR'></Trans>
                    </div>
                </div>
                <Row>
                    <Col>
                        <div className="card card-default">
                            <Persons height="650" type="parents" title="Foresatte"></Persons>
                            {/* START card footer */}
                        </div>
                    </Col>
                </Row>
...
export default withNamespaces('translations')(ParentsPage);